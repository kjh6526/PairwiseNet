from training.trainers.trainer import BaseTrainer, PairwiseNetTrainer, PcdEncoderTrainer
...
def get_trainer(optimizer, cfg):
    ...
    elif trainer_type == 'PcdEncoder':
        trainer = PcdEncoderTrainer(optimizer, cfg.training, device=device)
    return trainer
